...
$notifications = [
    'data' => [
        ['id' => 1, 'message' => 'New comment on your post', 'time' => '2 minutes ago', 'link' => '/comment/1'],
        ['id' => 2, 'message' => 'Your order has shipped', 'time' => '5 minutes ago', 'link' => '/order/123'],
    ],
    'totalData' => 234
];
...
$messages = [
    'data' => [
        ['id' => 1, 'message' => 'John Doe sent you a message', 'time' => '10 minutes ago', 'link' => '/message/1'],
        ['id' => 2, 'message' => 'Jane Smith sent you a message', 'time' => '30 minutes ago', 'link' => '/message/2'],
    ],
    'totalData' => 99
];
